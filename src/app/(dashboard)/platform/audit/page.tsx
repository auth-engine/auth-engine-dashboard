            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1">
                        Complete history of events across the entire platform.
                    </p>
                </div>
                                ...
                                <TableRow key={log.id} className="group transition-colors">
                                    ...
                                    <TableCell>
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-[10px] text-muted-foreground font-mono">{log.tenant_id ? `T: ${log.tenant_id.slice(0, 8)}` : "Platform"}</p>
                                        </div>
                                    </TableCell>
                                    <TableCell>
